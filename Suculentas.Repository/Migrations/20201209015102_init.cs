    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmpresaFretes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(nullable: false),
                    EmpresaFreteId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vendas_EmpresaFretes_EmpresaFreteId",
                        column: x => x.EmpresaFreteId,
                        principalTable: "EmpresaFretes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pedidos", x => new { x.VendaId, x.ProdutoId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vendas_EmpresaFreteId",
                table: "Vendas",
                column: "EmpresaFreteId");
